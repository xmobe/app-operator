...
import (
	...
	odootrackcomponents "github.com/xoe-labs/odoo-operator/pkg/controller/odootrack/components"
)
...
func Add(mgr manager.Manager) error {
	_, err := components.NewReconciler("odootrack.controller", mgr, &clusterv1beta1.OdooTrack{}, Templates, []components.Component{
		// Set default values.
		// odootrackcomponents.NewDefaults(),
		odootrackcomponents.NewMeta(),
	})
	return err
}
